...
The keys live in `.claude/settings.json` (project) or `/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
