...
> `/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/get-shit-done/USER-PROFILE.md` exists). Skip the Read
...
```bash
PROFILE_CONTENT=$(cat "/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a `Task()` in parallel:
   ...
   ```
   Task(
     prompt="First, read @/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/agents/gsd-advisor-researcher.md for your role and instructions.
