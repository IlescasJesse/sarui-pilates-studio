...
```bash
INIT=$(node "/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
