...
- **Global scope**: `/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/notes/`)
...
2. Glob `/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/notes/` — works in any directory
