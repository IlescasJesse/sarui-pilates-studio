...
```bash
INIT=$(node "/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/get-shit-done/templates/spec.md.
