...
```
Task(
  prompt="Read /Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jesseilescas/Documents/sarui/sarui-studio/.opencode/get-shit-done/templates/VALIDATION.md`
